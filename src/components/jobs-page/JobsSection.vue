        ...
        <div class="content">
            <aside class="filters">
                <div class="filters-content">
                    ...
                    <div class="toggle-filter">
                        <div @click="hybridToggle = !hybridToggle"
                             :class="{ 'toggle-container': true, on: hybridToggle }">
                            <div class="toggle"></div>
                        </div>
